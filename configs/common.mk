...
LOCAL_PATH:= vendor/noobbuilds/prebuilts/common/system
...
PRODUCT_COPY_FILES += \
    vendor/noobbuilds/prebuilts/shamu/system/media/bootanimation.zip:system/media/bootanimation.zip
endif

ifeq (noobbuilds_n9,$(TARGET_PRODUCT))
PRODUCT_COPY_FILES += \
    vendor/noobbuilds/prebuilts/flounder/system/media/bootanimation.zip:system/media/bootanimation.zip 
endif
...
$(call inherit-product, vendor/noobbuilds/extras/device-partial.mk)
